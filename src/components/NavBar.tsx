            ...
            {isOpen &&        
                <>
                    ...
                    <div className="fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-50">
                        <NavLinks className={`fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-50 transform transition-transform duration-300 "translate-x-0"`}></NavLinks>
                    </div>
                </>
            }
            <h1 className="text-xl font-bold text-gray-800">Mia Romagna</h1>
