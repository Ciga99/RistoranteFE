        ...
        <Card>
            <div className="flex flex-col sm:flex-row cursor-pointer gap-4">
                <div className="relative flex items-center justify-center group">
                    ...
                    <img className="h-56 w-full sm:h-48 sm:w-64 lg:h-64 lg:w-80 xl:h-72 xl:w-96 object-cover rounded-md flex-shrink-0" src={room.images[currentIndexImg].image} alt={room.name} />
