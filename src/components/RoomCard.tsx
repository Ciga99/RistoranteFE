        ...
        <Card>
            <div className="flex flex-col sm:flex-row cursor-pointer gap-4">
                <div className="relative flex items-center justify-center group">
                    {room.listOfImages.length > 1 && <ArrowBigLeft className="text-black absolute left-0 z-10 p-1 bg-white/50 rounded-full hover:bg-white transition-colors" onClick={handlePrevImg} />}
                    ...
                    {room.listOfImages.length > 1 && <ArrowBigRight className="text-black absolute right-0 z-10 p-1 bg-white/50 rounded-full hover:bg-white transition-colors" onClick={handleNextImg}/>}
                </div> 
